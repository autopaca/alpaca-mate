...
function AprDetails() {
    ...
    return (
        <>
            ...
            />
            <DetailsRow
                left={<><span className="mr-1">Trading Fees APR</span><span
                    className="text-xs lg:text-xl">(7-day avg.)</span></>}
                right={<InputAprComponent
            ...
            <DetailsRow
                left={<span>
                    <span>Total APY</span>
                    <InfoTooltip
                        title="After subtracting Borrowing Interest, Yield Farm and Trading Fee rewards are autocompounded into LP tokens. ALPACA rewards assume daily compounding"
                    />
                </span>}
                right={<AprComponent
